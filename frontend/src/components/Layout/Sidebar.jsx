...
const mainItems = [
  ...
  { path: '/clientes', icon: UserRound, label: 'Clientes' },
  ...
  { path: '/sugestoes-ia', icon: BrainCircuit, label: 'Sugestoes IA' },
  { path: '/assistente-ia', icon: MessageSquareText, label: 'Assistente IA' }
];

const extraItems = [
  { path: '/catalogo-online', icon: Warehouse, label: 'Catalogo Online' },
