    ...
    <header className="fixed top-0 left-0 right-0 md:left-44 h-[74px] bg-[#f3f3f3] border-b border-[#d8d8d8] z-30">
      <div className="h-full px-4 md:px-5 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          {showVendasTitle && <h1 className="text-[38px] leading-none font-semibold text-slate-900">Vendas</h1>}
        </div>

        <div className="flex items-center gap-2">
          <button
            type="button"
            className="w-9 h-9 rounded-full hover:bg-white/80 flex items-center justify-center text-slate-700"
            title="Mais opcoes"
          >
          ...
          <button
            type="button"
            className="w-9 h-9 rounded-full border border-[#d5d5d5] bg-white flex items-center justify-center text-slate-700"
            title="Nuvem"
          >
            <Cloud size={17} />
          </button>
